...
import com.hadikomik.alarm.ActivityAlarm;
import com.hadikomik.fragment.ViewPagerActivity;
import com.hadikomik.pesan.MainActivityOne;
...
public class HomeMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tombolLima.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeMainActivity.this, Fibonacci.class);
                startActivity(intent);
            }
        });
